...
import { USER_ADDRESS_MAP_CONFIRM } from "../state/action-types";
const lib=["places"]
...
const MapPage = (props) => {
    ...
    const onConfirm=()=>{
        ...
        if(places && places.length===1){
            ...
            alert("location selected succesfully")
            props.history.push("/shipping")


        }else{
            alert("place enter your address")
        }
    }
  ...
  return googleApiKey ? (
    <div className="full-container">
      <LoadScript libraries={lib} googleMapsApiKey={googleApiKey}>
        <GoogleMap
          id="sample-map"
